...
public class BackBook {
	...
	public static void BackBook() {
		...
		JFrame frame = new JFrame("从购物车删除");		
		...
		//提示框
		JLabel label1 = new JLabel("从购物车删除");
				...
				try {
					...
					if(currentBook.next()) {//该书存在
						if(currentBook.getInt("lend") == 0) {
							JOptionPane.showMessageDialog(null, "该书已经不在购物车，请删除其他图书！");
							return;
						}
						...
						if(lendBook == 0) {
							JOptionPane.showMessageDialog(null, "从购物车删除成功");						
						} else {
							JOptionPane.showMessageDialog(null, "从购物车删除失败！");
						}	
