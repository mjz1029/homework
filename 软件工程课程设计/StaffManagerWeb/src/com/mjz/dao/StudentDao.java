...
public class StudentDao extends BaseDao {
	public boolean addStudent(Student student){
		String sql = "insert into s_staff values(null,'"+student.getSn()+"','"+student.getName()+"'";
	...
	public boolean editStudent(Student student) {
		...
		String sql = "update s_staff set name = '"+student.getName()+"'";
	...
	public boolean editPassword(Student student,String newPassword) {
		// TODO Auto-generated method stub
		String sql = "update s_staff set password = '"+newPassword+"' where id = " + student.getId();
		return update(sql);
	}
}
