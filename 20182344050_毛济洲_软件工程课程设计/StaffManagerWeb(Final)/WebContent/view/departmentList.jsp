...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"DepartmentServlet?method=getDepartmentList&t="+new Date().getTime(),
	        idField:'id', 
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectRow == null){
            	...
            	$.messager.confirm("消息提醒", "将删除部门信息（如果部门下存在员工或教师则不能删除），确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
...
<body>
	...
	<div id="toolbar">
		...
		<div style="margin-top: 3px;">部门名称：<input id="departmentName" class="easyui-textbox" name="departmentName" />
