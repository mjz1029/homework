...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"StaffServlet?method=StaffList&t="+new Date().getTime(),
	        idField:'id', 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'department_id',title:'部门',width:150, 
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "将删除与员工相关的所有数据(包括成绩)，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
	  	...
	  	//下拉框通用属性
	  	$("#add_departmentList, #edit_departmentList").combobox({
	  		width: "200",
	  		height: "30",
	  		valueField: "id",
	  		textField: "name",
							...
							$.ajax({
								...
								success: function(msg){
									if(msg == "success"){
										...
										//重新刷新页面数据
										$('#dataList').datagrid("options").queryParams = {departmentid: departmentid};
							  			$('#dataList').datagrid("reload");
							  			setTimeout(function(){
											$("#departmentList").combobox('setValue', departmentid);
										}, 100);
	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							$.ajax({
								type: "post",
								url: "StaffServlet?method=EditStaff&t="+new Date().getTime(),
	  ...
	  //搜索按钮监听事件
	  	$("#search-btn").click(function(){
	  		$('#dataList').datagrid('load',{
	  			staffName: $('#search_staff_name').val(),
...
<body>
	...
	<div id="toolbar">
		...
		<div style="margin-left: 10px;margin-top:4px;" >部门：<input id="departmentList" class="easyui-textbox" name="department" />
	...
	<div id="addDialog" style="padding: 10px">  
    	...
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>部门:</td>
	    			<td><input id="add_departmentList" style="width: 200px; height: 30px;" class="easyui-textbox" name="departmentid" /></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
	...
	<div id="editDialog" style="padding: 10px">
    	...
    	<form id="editForm" method="post">
	    	...
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>部门:</td>
	    			<td><input id="edit_departmentList" style="width: 200px; height: 30px;" class="easyui-textbox" name="departmentid" /></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
