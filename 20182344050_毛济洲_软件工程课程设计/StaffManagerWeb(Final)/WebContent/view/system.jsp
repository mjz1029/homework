    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						...
						{"menuid":"2","icon":"","menuname":"员工信息管理",
							"menus":[
									{"menuid":"21","menuname":"员工列表","icon":"icon-user-staff","url":"StaffServlet?method=toStaffListView"},
								]
						},
						<c:if test="${userType == 1 || userType == 3}">
						{"menuid":"4","icon":"","menuname":"部门信息管理",
							"menus":[
									{"menuid":"42","menuname":"部门列表","icon":"icon-house","url":"DepartmentServlet?method=toDepartmentListView"}
								]
						},
						/* </c:if>
						<c:if test="${userType == 1 || userType == 3}">
						{"menuid":"3","icon":"","menuname":"教师信息管理",
							"menus":[
									{"menuid":"31","menuname":"教师列表","icon":"icon-user-staff1","url":"Staff1Servlet?method=toStaff1ListView"},
								]
						}, */
						</c:if>
						<c:if test="${userType == 1 || userType == 3}">
						{"menuid":"6","icon":"","menuname":"班种信息管理",
							"menus":[
									{"menuid":"61","menuname":"班种列表","icon":"icon-book-open","url":"DutyServlet?method=toDutyListView"},
								]
						},
						</c:if>
						{"menuid":"7","icon":"","menuname":"班种选择管理",
							"menus":[
									{"menuid":"71","menuname":"班种选择列表","icon":"icon-book-open","url":"SelectedDutyServlet?method=toSelectedDutyListView"},
								]
						}, 
...
<body class="easyui-layout" style="overflow-y: hidden"  scroll="no">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="padding-left:10px; font-size: 16px; ">员工信息管理系统</span>
    </div>
    <div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
        <div class="footer">Copyright &copy; By 【Harry Mao】</div>
    </div>
