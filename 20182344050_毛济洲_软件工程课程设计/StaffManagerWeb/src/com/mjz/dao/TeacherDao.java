...
import com.mjz.model.Student;
import com.mjz.model.Teacher;
...
public class TeacherDao extends BaseDao {
	public boolean addTeacher(Teacher teacher){
		String sql = "insert into s_staff1 values(null,'"+teacher.getSn()+"','"+teacher.getName()+"'";
	...
	public boolean editTeacher(Teacher teacher) {
		...
		String sql = "update s_staff1 set name = '"+teacher.getName()+"'";
	...
	public boolean editPassword(Teacher teacher,String newPassword) {
		// TODO Auto-generated method stub
		String sql = "update s_staff1 set password = '"+newPassword+"' where id = " + teacher.getId();
		return update(sql);
	}
}
