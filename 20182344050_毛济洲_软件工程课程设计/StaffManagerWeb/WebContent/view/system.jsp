    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						...
						{"menuid":"6","icon":"","menuname":"班种信息管理",
							"menus":[
									{"menuid":"61","menuname":"班种列表","icon":"icon-book-open","url":"CourseServlet?method=toCourseListView"},
								]
						},
						</c:if>
						{"menuid":"7","icon":"","menuname":"班种选择管理",
							"menus":[
									{"menuid":"71","menuname":"班种选择列表","icon":"icon-book-open","url":"SelectedCourseServlet?method=toSelectedCourseListView"},
								]
						}, 
