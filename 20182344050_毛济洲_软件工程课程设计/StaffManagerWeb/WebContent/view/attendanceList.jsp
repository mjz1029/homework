	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'studentId',title:'员工',width:200,
 		       	...
 		       	{field:'courseId',title:'班种',width:200,
 		        	formatter: function(value,row,index){
 						if (row.courseId){
...
<body>
	...
	<div id="toolbar">
		...
		<div style="margin-top: 3px;">
			员工：<input id="studentList" class="easyui-textbox" name="studentList" />
			班种：<input id="courseList" class="easyui-textbox" name="courseList" />
    	...
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		<tr>
	    			...
	    			<td colspan="3">
	    				<input id="add_studentList" style="width: 200px; height: 30px;" class="easyui-textbox" name="studentid" data-options="required:true, missingMessage:'请选择员工'" />
	    			</td>
	    		...
	    		<tr>
	    			...
	    			<td colspan="3">
	    				<input id="add_courseList" style="width: 200px; height: 30px;" class="easyui-textbox" name="courseid" data-options="required:true, missingMessage:'请选择班种'" />
	    			</td>
	    			<td style="width:80px"></td>
	    		</tr>
	    		<tr>
