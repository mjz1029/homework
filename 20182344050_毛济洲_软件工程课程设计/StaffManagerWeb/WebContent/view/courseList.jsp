	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'name',title:'班种名称',width:200},
 		       	{field:'teacherId',title:'值班员工',width:200,
 		       	...
 		       	{field:'courseDate',title:'上班时间',width:200},
...
<body>
	...
	<div id="toolbar">
		...
		<div style="margin-top: 3px;">
			班种名称：<input id="courseName" class="easyui-textbox" name="clazzName" />
			值班员工：<input id="teacherList" class="easyui-textbox" name="clazz" />
