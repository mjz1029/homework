...
<head>
	...
	$(function() {	
	  ...
	  //编辑请假信息
	  	$("#editDialog").dialog({
	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							var staffid = $("#edit_staffList").combobox("getValue");
							var id = $("#dataList").datagrid("getSelected").id;
							var info = $("#edit_info").textbox("getValue");
							var data = {id:id, staffid:staffid, info:info};
			...
			onBeforeOpen: function(){
				...
				var staffId = selectRow.staffId;
				setTimeout(function(){
					$("#edit_staffList").combobox('setValue', staffId);
				}, 100);
			},
			onClose: function(){
				$("#edit_info").val("");
	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							var staffid = $("#dataList").datagrid("getSelected").staffId;
							var id = $("#dataList").datagrid("getSelected").id;
							...
							var data = {id:id, staffid:staffid, info:info,remark:remark,status:status};
	  ...
	  //下拉框通用属性
	  	$("#add_staffList, #edit_staffList,#staffList").combobox({
	  		width: "200",
	  		height: "30",
	  		valueField: "id",
	  		textField: "name",
...
<body>
	...
	<div id="toolbar">
		...
		<div style="margin-top: 3px;">
			员工：<input id="staffList" class="easyui-textbox" name="staffid" />
    	...
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		<tr>
	    			...
	    			<td colspan="3">
	    				<input id="add_staffList" style="width: 300px; height: 30px;" class="easyui-textbox" name="staffid" data-options="required:true, missingMessage:'请选择员工信息'" />
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>请假原因:</td>
    	...
    	<form id="editForm" method="post">
	    	<table cellpadding="8" >
	    		<tr>
	    			<td style="width:60px">员工:</td>
	    			<td colspan="3">
	    				<input id="edit_staffList" style="width: 300px; height: 30px;" class="easyui-textbox" name="staffid" data-options="required:true, missingMessage:'请选择员工信息'" />
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>请假原因:</td>
